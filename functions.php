<?php
/**
 * Flutuante functions and definitions
 *
 * @package Flutuante
 * @since Flutuante 1.0
 */
...
function flutuante_setup() {
	 ...
	 * If you're building a theme based on Flutuante, use a find and replace
	 * to change 'flutuante' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'flutuante', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'flutuante' ),
	) );
